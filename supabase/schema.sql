...
create table if not exists public.projects (
  ...
  cover_resource_type text not null default 'image' check (cover_resource_type in ('image','video','raw')),
  gallery jsonb not null default '[]'::jsonb,
  video_url text,
  video_public_id text,
  video_resource_type text not null default 'video' check (video_resource_type in ('image','video','raw')),
  execution_date date,
